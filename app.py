...
st.set_page_config(page_title="Класифікатор багів", page_icon=None, layout="wide")
...
if st.session_state.get('authentication_status'):
    ...
    page = st.sidebar.radio("Оберіть розділ:", ["Нове звернення", "Історія оброблених звернень"])
    ...
    if page == "Нове звернення":
        ...
        tab1, tab2 = st.tabs(["Одне звернення", "Пакетна обробка"])
    ...
    elif page == "Історія оброблених звернень":
